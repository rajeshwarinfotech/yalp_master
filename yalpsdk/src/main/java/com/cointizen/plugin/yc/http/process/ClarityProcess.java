package com.cointizen.plugin.yc.http.process;
...
import com.cointizen.plugin.yc.http.request.ClarityRequest;
...
public class ClarityProcess {
	...
	private static final String TAG = "ClarityProcess";
	...
	public void post(Handler handler) {
		...
		if (null != params) {
			ClarityRequest loginRequest = new ClarityRequest(handler);
			loginRequest.post(MCHConstant.getInstance().getSdkBaseUrl()+"user/get_domain", params);
		} else {
