...
public class XListViewFooter extends LinearLayout{
	...
	public void setState(int state) {
		...
		if (state == STATE_READY) {
			...
			mHintView.setText(ViewConstants.S_pQJOryHgBG);
		} else if (state == STATE_LOADING) {
			mProgressBar.setVisibility(View.VISIBLE);
		} else {
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(ViewConstants.S_BdioCYUmeh);
		}
	}
	...
	private void initView(Context context) {
		...
		LinearLayout moreView = (LinearLayout)LayoutInflater.from(mContext).inflate(
				MCHInflaterUtils.getLayout(context, "mch_xlistview_footer"), null);
		addView(moreView);
		...
		mContentView = moreView.findViewById(
				MCHInflaterUtils.getControl(context, "xlistview_footer_content"));
		mProgressBar = moreView.findViewById(
				MCHInflaterUtils.getControl(context, "xlistview_footer_progressbar"));
		mHintView = (TextView)moreView.findViewById(
				MCHInflaterUtils.getControl(context, "xlistview_footer_hint_textview"));
	}
}
