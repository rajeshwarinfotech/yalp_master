...
public class GamePacksListRequest {
    private static final String TAG = "GamePacksListRequest";
    ...
    public void post(String url, RequestParams params) {
        if (TextUtils.isEmpty(url) || null == params) {
            ...
            noticeResult(Constant.GET_PACKS_LIST_FAIL, HttpConstants.S_VKHKJPHQds);
            return;
        }
        ...
        http.send(HttpRequest.HttpMethod.POST, url, params, new RequestCallBack<String>() {
            ...
            public void onFailure(HttpException error, String msg) {
                ...
                noticeResult(Constant.GET_PACKS_LIST_FAIL, HttpConstants.S_uVIIKmGFwV);
            }
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                try {
                    ...
                    MCLog.e(TAG, HttpConstants.Log_NlnopVxYKi + e);
                    noticeResult(Constant.GET_PACKS_LIST_FAIL, HttpConstants.S_bcwiMnfyeK);
                }
            }
        });
    }
...
//                }
            ...
            MCLog.e(TAG, HttpConstants.Log_GKWwGSKbsa + e);
        }
