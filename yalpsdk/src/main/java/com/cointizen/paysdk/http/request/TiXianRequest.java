...
import com.cointizen.paysdk.bean.TiXianBean;
...
public class TiXianRequest {
    ...
    public TiXianRequest(Handler mHandler) {
        http = new HttpUtils();
        if (null != mHandler) {
    ...
    public void post(String url, RequestParams params) {
        if (TextUtils.isEmpty(url) || null == params) {
            ...
            noticeResult(Constant.TIXIAN_FAIL, "参数异常");
            return;
        }
        ...
        http.send(HttpRequest.HttpMethod.POST, url, params, new RequestCallBack<String>() {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                TiXianBean giftDetModel = new TiXianBean();
                int status;
                try {
                    ...
                    if (status == 200) {
                        ...
                        giftDetModel.setIS_OPEN_SMALL_ACCOUNT(list.optInt("IS_OPEN_SMALL_ACCOUNT"));
                        noticeResult(Constant.TIXIAN_SUCCESS, giftDetModel);
                    } else {
                        String msg;
                        ...
                        MCLog.e(TAG, "msg:" + msg);
                        noticeResult(Constant.TIXIAN_FAIL, msg);
                    }
                } catch (JSONException e) {
                    noticeResult(Constant.TIXIAN_FAIL, "解析参数异常");
                    MCLog.e(TAG, "fun#post JSONException:" + e);
                } catch (Exception e) {
                    noticeResult(Constant.TIXIAN_FAIL, "Failed to connect to the server");
                }
