...
import com.cointizen.paysdk.http.request.SignDetRequest;
 ...
 * 签到详情信息
 */
public class SignDetProcess {

	private static final String TAG = "SignDetProcess";
	...
	public void post(Handler handler) {
		...
		if (null != params) {
			SignDetRequest signDetRequest = new SignDetRequest(handler);
			signDetRequest.post(MCHConstant.getInstance().getSignDet(), params);
		} else {
