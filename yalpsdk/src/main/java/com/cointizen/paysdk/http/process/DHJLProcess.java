...
import com.cointizen.paysdk.http.request.JfDHJLRequest;
 ...
 * 兑换记录
 */
public class DHJLProcess {

	private static final String TAG = "DHJLProcess";
	private String num;
	...
	public void post(Handler handler) {
		...
		if (null != params) {
			JfDHJLRequest loginRequest = new JfDHJLRequest(handler);
			loginRequest.post(MCHConstant.getInstance().getJFDHJL(), params);
		} else {
