...
import com.cointizen.paysdk.http.request.HelperListRequest;
 ...
 * 帮助中心
 */
public class HelperListProcess {

	private static final String TAG = "HelperListProcess";
	...
	public void post(Handler handler) {
		...
		if (null != params) {
			HelperListRequest loginRequest = new HelperListRequest(handler);
			loginRequest.post(MCHConstant.getInstance().getHelperList(), params);
		} else {
