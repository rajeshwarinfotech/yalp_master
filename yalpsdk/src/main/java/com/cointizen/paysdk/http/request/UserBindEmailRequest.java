...
public class UserBindEmailRequest {
    ...
    public UserBindEmailRequest(Handler mHandler) {
        http = new HttpUtils();
        if (null != mHandler) {
        ...
        http.send(HttpRequest.HttpMethod.POST, url, params,
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        if (status == 200) {
                            noticeResult(Constant.USER_BIND_EMAIL_SUCCESS, "");
                        } else {
                            String msg;
                            ...
                            MCLog.e(TAG, "msg:" + msg);
                            noticeResult(Constant.USER_BIND_EMAIL_FAIL, msg);
                        }
                    }
                    ...
                    public void onFailure(HttpException error, String msg) {
                        ...
                        noticeResult(Constant.USER_BIND_EMAIL_FAIL, "Failed to connect to the server");
                    }
                });
    }
