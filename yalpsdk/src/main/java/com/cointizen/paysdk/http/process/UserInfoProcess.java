...
import com.cointizen.paysdk.http.request.UserInfoRequest;
...
public class UserInfoProcess {
	...
	private static final String TAG = "UserInfoProcess";
	...
	public void post(Handler handler) {
		...
		if (null != handler) {
			new UserInfoRequest(handler).post(MCHConstant.getInstance().getUserInfoUrl(), params);
		    MCLog.w(TAG, MCHConstant.getInstance().getUserInfoUrl());
		}else{
