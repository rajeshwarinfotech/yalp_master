...
public class DeleteAccountProcess {
    ...
    public void post(Handler handler) {
        ...
        DeleteAccountRequest request = new DeleteAccountRequest(handler);
        request.post(MCHConstant.getInstance().getDelAccountUrl(), params);
    }
