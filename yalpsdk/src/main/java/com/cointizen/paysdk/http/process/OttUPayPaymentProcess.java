...
public class OttUPayPaymentProcess {
    ...
    public OttUPayPaymentProcess(OttUpayPaymentRequest mGatePaymentRequest) {
        this.ottUPayPaymentRequest = mGatePaymentRequest;
    }
    ...
    public void post(Handler mgateOrderPaymentHandler) {
        ...
        if (null != mgateOrderPaymentHandler && null != params) {
            ottUPayPaymentRequest.setHandler(mgateOrderPaymentHandler);
            ottUPayPaymentRequest.doPayment(param);
        } else {
