...
import com.cointizen.paysdk.http.request.GameVIPPacksListRequest;
...
public class GameVIPPacksListProcess {

	private static final String TAG = "GameTeQuanPacksListProcess";
	private String is_vip = "1"; //请求特权礼包列表 0否 1是
	...
	public void post(Handler handler){
		...
		if (null != handler) {
			new GameVIPPacksListRequest(handler).post(MCHConstant.getInstance().getGamePacksList(), params);
		}else{
