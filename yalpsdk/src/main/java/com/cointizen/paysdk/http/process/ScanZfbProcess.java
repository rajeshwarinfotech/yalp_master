...
import com.cointizen.paysdk.http.request.ScanZfbRequest;
...
public class ScanZfbProcess extends BaseProcess {

	private static final String TAG = "ScanZfbProcess";
	...
	public void post(Handler handler) {
		...
		if (null != handler && null != params) {
			ScanZfbRequest request = new ScanZfbRequest(handler);
			request.post(MCHConstant.getInstance().getGetZfbRqCode(), params);
		} else {
