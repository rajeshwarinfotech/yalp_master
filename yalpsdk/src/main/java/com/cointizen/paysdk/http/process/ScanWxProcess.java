...
import com.cointizen.paysdk.http.request.ScanWxRequest;
...
public class ScanWxProcess extends BaseProcess {

	private static final String TAG = "ScanWxProcess";
	...
	public void post(Handler handler) {
		...
		if (null != handler && null != params) {
			ScanWxRequest request = new ScanWxRequest(handler);
			request.post(MCHConstant.getInstance().getGetWxRqCode(), params);
		} else {
