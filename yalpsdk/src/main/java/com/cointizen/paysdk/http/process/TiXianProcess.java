...
import com.cointizen.paysdk.http.request.TiXianRequest;
 ...
 * 提现
 */
public class TiXianProcess {

	private static final String TAG = "TiXianProcess";
	...
	public void post(Handler handler) {
		...
		if (null != params) {
			TiXianRequest loginRequest = new TiXianRequest(handler);
			loginRequest.post(MCHConstant.getInstance().getTiXian(), params);
		} else {
