...
import com.cointizen.paysdk.activity.MGatePaymentActivity;
...
public class MGatePaymentRequest {

    AppCompatActivity activity;
    private static final String TAG = "MGatePaymentRequest";
    Fragment fragment;
    ...
    public MGatePaymentRequest(AppCompatActivity activity) {
    ...
    public void doPayment(String params) {
        ...
        retrofit2.Call<String> paymentIntentCall = RetroInstance.getRetrofitInstance().createYalpPayment("mgate", requestBody);
        ...
        paymentIntentCall.enqueue(new retrofit2.Callback<String>() {
            ...
            public void onResponse(retrofit2.Call<String> call, retrofit2.Response<String> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Log.i(TAG, "MGate API response: " + body);
                    if(body == null) {
                    ...
                    Intent intent = new Intent(activity, MGatePaymentActivity.class);
                    if(responseObject.get("msg") != null && responseObject.get("msg").getAsString().equals("succeed")) {
                        intent.putExtra("url", responseObject.get("data").getAsJsonObject().get("pay_url").getAsString());
                    }
                    else {
                        showErrorDialog();
