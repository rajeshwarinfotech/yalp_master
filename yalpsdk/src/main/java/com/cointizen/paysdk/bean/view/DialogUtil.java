package com.cointizen.paysdk.bean.view;
...
/**
 * author Administrator 2014-7-23上午9:41:45
 */
public class DialogUtil {
	...
	private static void init(Context context) {
		dialog = new Dialog(context, MCHInflaterUtils.getIdByName(context, "style",
				"mch_tip_dialog"));
		view = LayoutInflater.from(context).inflate(
				MCHInflaterUtils.getIdByName(context, "layout", "mch_tip_dialog"), null);
		iv_pd = (ImageView) view.findViewById(MCHInflaterUtils.getIdByName(context,
				"id", "iv_circle"));
		dialog.setCancelable(false);
		dialog.setCanceledOnTouchOutside(false);
		tv_msg = (TextView) view.findViewById(MCHInflaterUtils.getIdByName(context,
				"id", "tv_msg"));
