...
public class SelectBindPTBDialog extends DialogFragment {
     ...
     * 日志打印
     */
    private static final String TAG = "SelectPTBDialog";
    /**
     * 上下文
     */
    private Context con;
    ...
    public SelectBindPTBDialog(Context con) {
        this.con = con;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        try {
            containerView = inflater.inflate(MCHInflaterUtils.getIdByName(con,
                    "layout", "mch_dialog_select_bind_ptb"), container, false);
            // 如果有信息,显示加载信息
            Bundle bundle = getArguments();
            if (bundle == null) {
                return containerView;
            }
            isGamePtb = true;  //默认是否是绑币
            ...
            String str = payptb.toString().trim().substring(0, 11);
            String money = payptb.toString().trim().substring(11);
            ...
            final Button btnPtbPay = (Button) containerView.findViewById(MCHInflaterUtils.getIdByName(con, "id", "btn_mch_dialog_ptbpay"));
    ...
    public static class Builder {
        ...
        private SelectBindPTBDialog create(Context con) {
            final SelectBindPTBDialog dialog = new SelectBindPTBDialog(con);
            // 1,设置显示内容
        ...
        public SelectBindPTBDialog show(Context con, FragmentManager fm, DiscountPrice discountPrice) {
            if (fm == null) {
            ...
            SelectBindPTBDialog dialog = create(con);
            MCLog.d(TAG, "show SelectPTBDialog.");
