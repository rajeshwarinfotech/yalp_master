...
//    private TextView tv_point;
    ...
    public PayLoadingDialog(Context con) {
        mContent = con;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View containerView = inflater.inflate(MCHInflaterUtils.getIdByName(mContent,
                "layout", "mch_loading_pay_layout"), container, false);
...
//                .setOnClickListener(closeClick);
        iv_route = containerView.findViewById(MCHInflaterUtils.getControl(mContent, "img_pay_route"));
...
//        tv_point = containerView.findViewById(MCHInflaterUtils.getControl(mContent, "tv_point"));
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 设置对话框的样式
        setStyle(STYLE_NO_FRAME, MCHInflaterUtils.getIdByName(mContent, "style", "mch_MCTipDialog"));
    }
    ...
    public void onStart() {
        ...
        if (width >= height) {// 横屏
            ...
            size_x = (int) (width * 0.7);
            size_y = (int) (width * 0.6);
        }
...
//                tv_point.setText(builder.toString());
    ...
    public static class Builder {
        ...
        private PayLoadingDialog create(Context context) {
            final PayLoadingDialog dialog = new PayLoadingDialog(context);
            // 1,设置显示内容
        ...
        public PayLoadingDialog show(Context context, FragmentManager fm) {
            if (fm == null) {
                MCLog.e(TAG, "show error : fragment manager is null.");
                return null;
            }

            PayLoadingDialog dialog = create(context);
