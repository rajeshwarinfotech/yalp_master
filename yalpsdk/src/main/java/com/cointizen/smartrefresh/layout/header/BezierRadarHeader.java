...
import com.cointizen.smartrefresh.layout.internal.InternalAbstract;
...
public class BezierRadarHeader extends InternalAbstract implements RefreshHeader {
    ...
    //<editor-fold desc=AppConstants.STR_38ece46d40c72859129449a557f2b34a>
...
//        TypedArray ta = context.obtainStyledAttributes(attrs, MCHInflaterUtils.getStyleableIntArray(context,"BezierRadarHeader"));
//
//        mEnableHorizontalDrag = ta.getBoolean(MCHInflaterUtils.getStyleableFieldId(context,
//                "styleable","BezierRadarHeader_srlEnableHorizontalDrag"), mEnableHorizontalDrag);
//        setAccentColor(ta.getColor(MCHInflaterUtils.getStyleableFieldId(context,
//                "styleable","BezierRadarHeader_srlAccentColor"), 0xFFffffff));
//        setPrimaryColor(ta.getColor(MCHInflaterUtils.getStyleableFieldId(context,
//                "styleable","BezierRadarHeader_srlPrimaryColor"), 0xFF222222));
//        mManualAccentColor = ta.hasValue(MCHInflaterUtils.getStyleableFieldId(context,
//                "styleable","BezierRadarHeader_srlAccentColor"));
//        mManualPrimaryColor = ta.hasValue(MCHInflaterUtils.getStyleableFieldId(context,
//                "styleable","BezierRadarHeader_srlPrimaryColor"));
//
//        ta.recycle();
...
//        }
    ...
    //<editor-fold desc=AppConstants.STR_5bd395e3e38151310182ad131ce2c5ad>
    @Override
    ...
    //<editor-fold desc=AppConstants.STR_a0e3b7a25569047613b2a3fda84b2d13>
...
//    }
    ...
    //<editor-fold desc=AppConstants.STR_ec72826ae83facc2ab4782d92599c8b1>
    ...
    //<editor-fold desc=AppConstants.STR_02ba6f5aceffe2c2dc747183efe19069>
