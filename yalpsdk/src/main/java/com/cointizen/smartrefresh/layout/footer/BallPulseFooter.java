...
public class BallPulseFooter extends InternalAbstract implements RefreshFooter {
    ...
    //<editor-fold desc=AppConstants.STR_f9d22a925f93c94b45e4a8d8fa32cf48>
...
//    protected SpinnerStyle mSpinnerStyle = SpinnerStyle.Translate;
    ...
    //<editor-fold desc=AppConstants.STR_088a74e1609e3521248696d6b4151185>
...
//        TypedArray ta = context.obtainStyledAttributes(attrs, MCHInflaterUtils.getStyleableIntArray(context,"BallPulseFooter"));
...
//        mSpinnerStyle = SpinnerStyle.values()[ta.getInt( MCHInflaterUtils.getStyleableFieldId(context,"styleable","BallPulseFooter_srlClassicsSpinnerStyle"), mSpinnerStyle.ordinal())];
//
//        if (ta.hasValue(MCHInflaterUtils.getStyleableFieldId(context,
//                "styleable","BallPulseFooter_srlNormalColor"))) {
//            setNormalColor(ta.getColor(MCHInflaterUtils.getStyleableFieldId(context,
//                    "styleable","BallPulseFooter_srlNormalColor"), 0));
//        }
//        if (ta.hasValue(MCHInflaterUtils.getStyleableFieldId(context,
//                "styleable","BallPulseFooter_srlAnimatingColor"))) {
//            setAnimatingColor(ta.getColor(MCHInflaterUtils.getStyleableFieldId(context,
//                    "styleable","BallPulseFooter_srlAnimatingColor"), 0));
//        }
//
//        ta.recycle();
    ...
    //<editor-fold desc=AppConstants.STR_5b149811027b375b45cbf5338d3d8236>
